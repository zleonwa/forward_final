            ...
            <div class="container-fluid">
			  ...
			  <br>
				...
				<div class="form-group row">
				    ...
				    <input id="userid" name="userid" type="id" class="input-sm" placeholder="2~15자" equired autofocus>
				</div>
				<div class="form-group row">
				    <label for="pwd1" class="col-sm-2 col-form-label"l>비밀번호</label>
				    <input id="pwd1" name="pwd1" type="password" class="input-sm" placeholder="8~15자" required>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					<label  class="col-sm-2 col-form-label">주소</label>
						<input type="text" name="" class="postcodify_postcode5 float-left input-sm" id="sample6_postcode" placeholder="우편번호" value="" />
						<button id="postcodify_search_button" class="btn btn-info btn-sm" onclick="sample6_execDaumPostcode()" id="btn" value="우편번호 찾기">검색</button>
						<input type="text" name="" class="postcodify_address input-sm" id="sample6_address" placeholder="주소" value=""/>
						<input type="text" name="" class="postcodify_details input-sm" id="sample6_address2" placeholder="상세주소" value="" />
				</div>
				<div class="form-group row">
				    <label pwd="" class="col-sm-2 col-form-label">관리 게시판</label>
				    <select id="email" name="email" class="input-sm 0stnum">
				    	<option>자유게시판</option>
				    	<option>공지게시판</option>
				    </select>
				</div>
				<div class="form-group row ">
				  <button type="button" class="btn btn-success" id="btnSubmit"> 제출 </button>
